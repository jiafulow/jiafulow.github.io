...
How to use the CMSSW TensorFlow interface is described in [these slides](https://indico.cern.ch/event/798721/contributions/3464668/attachments/1864097/3064610/2019-06-18_ML_TFinCMS.pdf). Documentation can be found in this repo: <https://gitlab.cern.ch/mrieger/CMSSW-DNN> (mirror: <https://github.com/riga/CMSSW-DNN>).
